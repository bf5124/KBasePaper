...
# different file types separated into their own subdirectories

training_dir_names =  ['genomic.fna',
                       'genomic.gbff',
                       'genomic.gff',
...
training_paths = [ datadir + tf for tf in training_dir_names ]

print( "Training data to be read from:" )
